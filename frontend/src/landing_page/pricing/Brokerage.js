        ...
        <div className="charge-col">
          ...
          <ul className="bullet-list">
            <li>
              ...
              Interest is applicable from T+1 day until the MTF stocks are sold.
            </li>
            <li>
